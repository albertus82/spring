...
@EnableTransactionManagement(proxyTargetClass = false, mode = AdviceMode.PROXY) // Abilita l'AOP per la gestione delle transazioni. I parametri aggiuntivi sono facoltativi.
public class RootConfig {
	...
	@Bean protected NamedParameterJdbcOperations jdbcOperations(DataSource dataSource) {
